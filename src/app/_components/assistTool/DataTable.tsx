...
export function DataTable<TData, TValue>({ columns, data, setToggleAssist }: DataTableProps<TData, TValue>) {
    ...
    return (
        <div className="flex justify-center max-w-full min-w-full ">
            <div className="lg:max-h-[65vh] lg:min-h-[65vh] lg:max-w-[60vw] lg:min-w-[50vw] lg:mt-16 my-[2.5vh] flex flex-col max-w-full max-h-[80vh] bg-yellow-950 text-[#E8E4D9] border-2 border-yellow-700">
                <Button
