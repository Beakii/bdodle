    ...
    return (
        <main className="flex flex-col lg:min-w-[50vw] mx-auto">
            ...
            <p className="text-wrap pb-5">BDOdle utilizes
                ...
                to gather information about the device and location the webpage is being accesed from for the sole purpose of optimizing the webpage and improve the user experience.
            </p>
