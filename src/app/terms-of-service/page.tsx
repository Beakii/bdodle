export default async function HomePage() {
    return (
        <main className="flex flex-col lg:min-w-[50vw] mx-auto">
            ...
            <ul>
                <li>
                    <p><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named BDOdle</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to BDOdle.</p>
                </li>
                <li>
